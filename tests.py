...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        # party details
        result = self.client.get("/")
        self.assertIn(b" <h2>Please RSVP</h2>\n\n", result.data)
    ...
    def test_rsvp(self):
        ...
        # not the RSVP form
        print(result.data)
        self.assertIn(b"<h2>After-Party Info</h2>", result.data)
        self.assertNotIn(b">Name</label>", result.data)
        print("FIXME")
...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def test_games(self):
        # FIXME: test that the games page displays the game from example_data()
            ...
            self.assertIn(b"Rennaissance Scares",result.data)
